...
| pandas-dev/pandas | Python | [ENH: raise TypeError if offsets which are not supported as period frequency pass to asfreq  ](https://github.com/pandas-dev/pandas/issues/56718) | 5 |
