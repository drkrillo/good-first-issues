...
## List of Good First Issues to start Collaborating! :surfer: <sub><sub>Last run: 2024-05-12</sub></sub>

| Repo | Language | Title | Comments |
| --- | --- | --- | --- |
| godotengine/godot | C++ | [Blur shader doesn't work in WebGL 2.0](https://github.com/godotengine/godot/issues/91717) | 1 |
| godotengine/godot | C++ | [Soft body does nothing if it's Mesh is array mesh programmatically created with  SurfaceTool](https://github.com/godotengine/godot/issues/91690) | 3 |
...
| godotengine/godot | C++ | [[TRACKER] Unit tests to add or improve](https://github.com/godotengine/godot/issues/43440) | 173 |
...
| ansible/ansible-documentation | Python | [Document how to tag releases](https://github.com/ansible/ansible-documentation/issues/1272) | 0 |
...
| pandas-dev/pandas | Python | [DEPR: Deprecate method argument of reindex_like ](https://github.com/pandas-dev/pandas/issues/58667) | 1 |
...
| pandas-dev/pandas-stubs | Python | [Implement ExtensionArray _accumulate and _reduce](https://github.com/pandas-dev/pandas-stubs/issues/850) | 5 |
