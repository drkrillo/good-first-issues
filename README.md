...
## List of Good First Issues to start Collaborating! :surfer: <sub><sub>Last run: 2025-01-22</sub></sub>
...
| pytorch/xla | C++ | [Op info test for `kthvalue`](https://github.com/pytorch/xla/issues/7458) | 1 |
...
| godotengine/godot | C++ | ["Save branch as scene" with "Reset Scale" sets scale to 0](https://github.com/godotengine/godot/issues/101907) | 3 |
...
| pytorch/xla | C++ | [[HARD] Op info test for `linalg.det`](https://github.com/pytorch/xla/issues/7478) | 4 |
...
| django/djangoproject.com | PostScript | [Simplify header text in community pages](https://github.com/django/djangoproject.com/issues/1563) | 8 |
| django/djangoproject.com | PostScript | [Make right sidebar independent from main content](https://github.com/django/djangoproject.com/issues/1366) | 11 |
...
| ansible/ansible-dev-tools | Python | [Ensure tests are passing with devspaces container](https://github.com/ansible/ansible-dev-tools/issues/467) | 0 |
...
| pytorch/torchft | Python | [Use bucketized model averaging for LocalSGD](https://github.com/pytorch/torchft/issues/66) | 0 |
...
| pytorch/ao | Python | [[QAT] Low-bit FSDP all-gather for QAT](https://github.com/pytorch/ao/issues/1224) | 1 |
| pytorch/ao | Python | [[MX | Triton] Create MX matmul op using new `scaled_dot` op in Triton](https://github.com/pytorch/ao/issues/1084) | 1 |
...
| pytorch/pytorch | Python | [Device check missing in torch.linalg.solve_triangular leading to hard crash](https://github.com/pytorch/pytorch/issues/142048) | 4 |
| pytorch/pytorch | Python | [torch._dynamo.exc.Unsupported: builtin: bool [<class 'torch._dynamo.variables.tensor.SymNodeVariable'>] False](https://github.com/pytorch/pytorch/issues/136075) | 4 |
...
| pytorch/pytorch | Python | [AOTAutograd: functionalization should emit foreach_copy_() instead of copy_() when possible](https://github.com/pytorch/pytorch/issues/119191) | 5 |
...
| pytorch/torchft | Python | [[CheckpointServer] use streaming transfers](https://github.com/pytorch/torchft/issues/36) | 5 |
...
| pytorch/pytorch | Python | [broken `torch.compile` with `"meta"` device tensors](https://github.com/pytorch/pytorch/issues/144607) | 6 |
...
| pandas-dev/pandas | Python | [Inconsistent behaviour when assigning to series?](https://github.com/pandas-dev/pandas/issues/25548) | 7 |
...
| pytorch/torchchat | Python | [Multimodal Eval Enablement (Looking for Developer to Implement Design)](https://github.com/pytorch/torchchat/issues/1334) | 13 |
...
| pandas-dev/pandas | Python | [DOC: Fix docs for various offset constructors](https://github.com/pandas-dev/pandas/issues/52431) | 29 |
| pandas-dev/pandas | Python | [DOC: fix docstring validation errors for pandas.Series](https://github.com/pandas-dev/pandas/issues/59592) | 36 |
| pandas-dev/pandas | Python | [DOC: Additional items for the cheat sheet](https://github.com/pandas-dev/pandas/issues/40680) | 39 |
| fastapi/fastapi | Python | [ApiKey Header documentation](https://github.com/fastapi/fastapi/issues/142) | 45 |
| pandas-dev/pandas | Python | [Various methods don't call call __finalize__](https://github.com/pandas-dev/pandas/issues/28283) | 48 |
...
| godotengine/godot-docs | reStructuredText | [Add clarification about what CharacterBody is used for](https://github.com/godotengine/godot-docs/issues/10458) | 1 |
| godotengine/godot-docs | reStructuredText | [Animated gif has visual artifacts](https://github.com/godotengine/godot-docs/issues/10425) | 1 |
...
| godotengine/godot-docs | reStructuredText | [MultiMesh resource buffer description](https://github.com/godotengine/godot-docs/issues/9891) | 1 |
...
| godotengine/godot-docs | reStructuredText | [Improve ArrayMesh examples by adding a rectangle example](https://github.com/godotengine/godot-docs/issues/9620) | 1 |
...
| godotengine/godot-docs | reStructuredText | [Rewording/amendment for Camera2D.align () function.](https://github.com/godotengine/godot-docs/issues/7307) | 1 |
...
| godotengine/godot-docs | reStructuredText | [Document `@export_tool_button` and `[ExportToolButton]`](https://github.com/godotengine/godot-docs/issues/10303) | 2 |
