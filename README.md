...
## List of Good First Issues to start Collaborating!:surfer:<sub><sub>Last run: 2023-11-11</sub></sub>

| Repo | Language | Title | Comments |
| --- | --- | --- | --- |
| godotengine/godot | C++ | [Executing `Image.convert` function crashes Godot](https://github.com/godotengine/godot/issues/84750) | 1 |
...
| pandas-dev/pandas | Python | [DOC: Add docstrings for MultiIndex.levels and MultiIndex.codes](https://github.com/pandas-dev/pandas/issues/55435) | 7 |
