...
## List of Good First Issues to start Collaborating! :surfer: <sub><sub>Last run: 2025-04-20</sub></sub>
...
| godotengine/godot | [Animation Optimization results for Nearest Interpolation is not correct](https://github.com/godotengine/godot/issues/105385) | 2 |
...
| godotengine/godot | [`_OnTreeItemSelected()` signal receiver method using C# doesn't allow adding of items](https://github.com/godotengine/godot/issues/103101) | 3 |
...
| godotengine/godot | [AnimationPlayerEditor inserts markers and keys at the mouse cursor position, not at the timeline cursor](https://github.com/godotengine/godot/issues/103272) | 11 |
...
| godotengine/godot | [[TRACKER] Unit tests to add or improve](https://github.com/godotengine/godot/issues/43440) | 225 |
...
| pytorch/torchchat | [torchtune as an optional dependency: Lazy Import](https://github.com/pytorch/torchchat/issues/1519) | 0 |
...
| huggingface/diffusers | [`prepare_image` in Kandinsky pipelines doesn't support `torch.Tensor`](https://github.com/huggingface/diffusers/issues/11060) | 1 |
...
| huggingface/huggingface_hub | [Dynamic commit sizes in `upload-large-folder`](https://github.com/huggingface/huggingface_hub/issues/3010) | 1 |
...
| pytorch/ao | [Unittests Migration Progress](https://github.com/pytorch/ao/issues/1621) | 1 |
...
| ansible/awx | [Add option to force the user to reset its password at first login](https://github.com/ansible/awx/issues/15766) | 2 |
...
| pytorch/executorch | [[0.6 Release] Quality testing](https://github.com/pytorch/executorch/issues/9837) | 2 |
| pytorch/executorch | [Remove EXECUTORCH_BUILD_HOST_TARGETS](https://github.com/pytorch/executorch/issues/9404) | 2 |
| pytorch/executorch | [Python apis for loading and saving .ptd from dictionaries](https://github.com/pytorch/executorch/issues/8542) | 2 |
| pytorch/executorch | [insert_write_back_for_buffers_pass should inject copy_ nodes at the earliest possible spot.](https://github.com/pytorch/executorch/issues/7345) | 2 |
...
| pytorch/executorch | [Support Dynamically Quantized Convolutions](https://github.com/pytorch/executorch/issues/9021) | 3 |
...
| pytorch/ao | [Accelerate activation sparsity with activation compression](https://github.com/pytorch/ao/issues/1920) | 4 |
...
| pytorch/executorch | [Don't Serialize Scales/ZP in Flatbuffer](https://github.com/pytorch/executorch/issues/9029) | 4 |
...
| pytorch/executorch | [Check tensor's dim order ambiguity in IR verifier](https://github.com/pytorch/executorch/issues/9942) | 5 |
...
| pytorch/pytorch | [Dead link in `torch.compile` docs](https://github.com/pytorch/pytorch/issues/119272) | 5 |
...
| pytorch/pytorch | [[dynamo] Missing support for many trivial builtin functions in operator](https://github.com/pytorch/pytorch/issues/116396) | 5 |
...
| pytorch/executorch | [[Request Impl] Apply Segment Serialization in Bundled Program](https://github.com/pytorch/executorch/issues/9771) | 6 |
...
| pytorch/xla | [[scan] Avoid re-tracing the combine function on every call](https://github.com/pytorch/xla/issues/8632) | 7 |
...
| pytorch/torchchat | [Simplify TokenizerArgs __post_init__: Unnecessarily verbose](https://github.com/pytorch/torchchat/issues/1518) | 8 |
...
| huggingface/transformers | [FSDP Torch XLA vs. FSDPv2 (SMPD) Torch XLA checkpoint saving bug](https://github.com/huggingface/transformers/issues/36004) | 9 |
...
| pytorch/executorch | [_load_for_executorch pybinding cannot load model for training](https://github.com/pytorch/executorch/issues/4908) | 9 |
...
| pytorch/pytorch | [bmm, topk, cholesky, linalg.norm, max with out variants set causing recompilations in torch.compile](https://github.com/pytorch/pytorch/issues/135859) | 9 |
...
| fastapi/fastapi | [Dependency Models created from Form input data are loosing metadata(field set) and are enforcing validation on default values.](https://github.com/fastapi/fastapi/issues/13399) | 12 |
...
| huggingface/transformers | [[FSDP][torch.compile] accelerator.unwrap_model and trainer._save work incorrectly when FSDP + torch.compile](https://github.com/huggingface/transformers/issues/37519) | 17 |
...
| huggingface/transformers | [[Community contributions] Model cards](https://github.com/huggingface/transformers/issues/36979) | 62 |
...
| huggingface/chat-ui | [Add option for users to customize search engines in settings page](https://github.com/huggingface/chat-ui/issues/1756) | 2 |
