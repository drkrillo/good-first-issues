...
## List of Good First Issues to start Collaborating! :surfer: <sub><sub>Last run: 2024-06-16</sub></sub>

| Repo | Language | Title | Comments |
| --- | --- | --- | --- |
| godotengine/godot | C++ | [Executing `RenderingServer.environment_set_ssr_roughness_quality` function crashes Godot](https://github.com/godotengine/godot/issues/92960) | 2 |
| godotengine/godot | C++ | [Empty mesh causes SurfaceTools::generate_tangents to fail an assertion which doesn't make sense.](https://github.com/godotengine/godot/issues/92395) | 2 |
| godotengine/godot | C++ | [CanvasModulate color too bright when using 2D HDR](https://github.com/godotengine/godot/issues/92796) | 3 |
...
| godotengine/godot | C++ | [[TRACKER] Unit tests to add or improve](https://github.com/godotengine/godot/issues/43440) | 178 |
...
| godotengine/godot-benchmarks | GDScript | [[Call to Action] Benchmarks for the benchmark server](https://github.com/godotengine/godot-benchmarks/issues/36) | 4 |
...
| pandas-dev/pandas | Python | [ENH: Expose `to_pandas_kwargs` in `read_parquet` for pyarrow engine](https://github.com/pandas-dev/pandas/issues/49236) | 3 |
...
| pandas-dev/pandas | Python | [DOC: Docstrings missing from .py files in Sphinxext docs folder](https://github.com/pandas-dev/pandas/issues/58812) | 7 |
...
| pandas-dev/pandas | Python | [Extreme performance issue in pandas 1.0.3 when setting a new column with DatetimeIndex](https://github.com/pandas-dev/pandas/issues/34531) | 9 |
...
| godotengine/godot-docs | reStructuredText | [Offline stable docs](https://github.com/godotengine/godot-docs/issues/9419) | 4 |
