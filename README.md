...
## List of Good First Issues to start Collaborating!:surfer:<sub><sub>Last run: 2023-10-25</sub></sub>

| Repo | Language | Title | Comments |
| --- | --- | --- | --- |
| godotengine/godot | C++ | [Improve textureSize usage in process material](https://github.com/godotengine/godot/issues/83894) | 1 |
...
| godotengine/godot | C++ | [[TRACKER] Unit tests to add or improve](https://github.com/godotengine/godot/issues/43440) | 132 |
...
| pandas-dev/pandas | Python | [BUG: pandas.read_excel() with dtype=object is broken in pandas 2.1.1](https://github.com/pandas-dev/pandas/issues/55489) | 7 |
