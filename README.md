...
| pandas-dev/pandas-stubs | Python | [Series apply frozenset raises error, frozenset not in enumerated Callable output types](https://github.com/pandas-dev/pandas-stubs/issues/871) | 2 |
