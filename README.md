...
## List of Good First Issues to start Collaborating! :surfer: <sub><sub>Last run: 2024-07-27</sub></sub>
...
| pandas-dev/pandas | Python | [pandas.Series.groupby example is not relevant](https://github.com/pandas-dev/pandas/issues/59309) | 6 |
...
| pandas-dev/pandas | Python | [BUG: numpy.maximum(pandas.Timestamp(...), pandas.Series(..., dtype='datetime64')) fails with TypeError](https://github.com/pandas-dev/pandas/issues/50864) | 6 |
...
| pandas-dev/pandas | Python | [BUG (?): dtype.value_counts() shows categorical multiple times](https://github.com/pandas-dev/pandas/issues/40735) | 18 |
...
| pandas-dev/pandas | Python | [BUG: _validate_setitem_value fails to raise for PandasArray](https://github.com/pandas-dev/pandas/issues/51044) | 22 |
