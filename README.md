...
## List of Good First Issues to start Collaborating! :surfer: <sub><sub>Last run: 2024-05-28</sub></sub>

| Repo | Language | Title | Comments |
| --- | --- | --- | --- |
| godotengine/godot | C++ | [Custom icons size in group editor is not standardized ](https://github.com/godotengine/godot/issues/92361) | 2 |
...
| godotengine/godot | C++ | [Vulkan: "Display unshaded" option still shows camera effects such depth of field](https://github.com/godotengine/godot/issues/49696) | 8 |
...
| godotengine/godot | C++ | [[TRACKER] Unit tests to add or improve](https://github.com/godotengine/godot/issues/43440) | 177 |
...
| godotengine/godot-benchmarks | GDScript | [[Call to Action] Benchmarks for the benchmark server](https://github.com/godotengine/godot-benchmarks/issues/36) | 3 |
...
| pandas-dev/pandas | Python | [DOC: Enhance the docstrings to provide more detailed explanations for the functions and their parameters in Common.py](https://github.com/pandas-dev/pandas/issues/58824) | 3 |
...
| pandas-dev/pandas | Python | [DOC: Docstrings missing from .py files in Sphinxext docs folder](https://github.com/pandas-dev/pandas/issues/58812) | 6 |
...
| godotengine/godot-docs | reStructuredText | [Offline stable docs](https://github.com/godotengine/godot-docs/issues/9419) | 3 |
