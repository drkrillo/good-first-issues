...
## List of Good First Issues to start Collaborating!:surfer:<sub><sub>Last run: 2024-01-03</sub></sub>
...
| pandas-dev/pandas | Python | [CLN: Use assert_produces_warning instead of pytest.raises to show FutureWarning](https://github.com/pandas-dev/pandas/issues/56716) | 0 |
...
| ansible/awx | Python | [Non descriptive error when podman is missing](https://github.com/ansible/awx/issues/14341) | 1 |
...
| ansible/awx | Python | [ visualizer info field ](https://github.com/ansible/awx/issues/14597) | 2 |
...
| pandas-dev/pandas | Python | [BUG: Docs won't build (S3 bucket does not exist)](https://github.com/pandas-dev/pandas/issues/56592) | 9 |
