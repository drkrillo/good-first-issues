...
## List of Good First Issues to start Collaborating!:surfer:<sub><sub>Last run: 2024-01-02</sub></sub>
...
| pandas-dev/pandas | Python | [BUG: Docs won't build (S3 bucket does not exist)](https://github.com/pandas-dev/pandas/issues/56592) | 7 |
