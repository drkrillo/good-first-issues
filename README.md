...
## List of Good First Issues to start Collaborating! :surfer: <sub><sub>Last run: 2024-09-04</sub></sub>
...
| pytorch/xla | C++ | [Confusion between xla_model.xla_device() and runtime.xla_device()](https://github.com/pytorch/xla/issues/7831) | 0 |
...
| pytorch/xla | C++ | [Op info test for `nn.functional.normalize .. nn.functional.pdist`](https://github.com/pytorch/xla/issues/7525) | 0 |
| pytorch/xla | C++ | [Op info test for `nn.functional.max_pool2d .. nn.functional.max_unpool3d`](https://github.com/pytorch/xla/issues/7524) | 0 |
| pytorch/xla | C++ | [Op info test for `nn.functional.leaky_relu .. nn.functional.max_pool1d`](https://github.com/pytorch/xla/issues/7523) | 0 |
...
| pytorch/xla | C++ | [Op info test for `nn.functional.feature_alpha_dropout .. nn.functional.grid_sample`](https://github.com/pytorch/xla/issues/7521) | 0 |
...
| pytorch/xla | C++ | [Op info test for `qr .. randn_like`](https://github.com/pytorch/xla/issues/7530) | 1 |
...
| godotengine/godot | C++ | [Every time I start a new project, a warning is printed about an unavailable file (due to it being referenced in `editor_layout.cfg`)](https://github.com/godotengine/godot/issues/95472) | 4 |
...
| godotengine/godot | C++ | [Resetting the pivot of a sprite with the "set rotation pivot tool", resets the temp pivot, not the actual pivot.](https://github.com/godotengine/godot/issues/96461) | 5 |
...
| godotengine/godot | C++ | [Improve error reporting when rcedit fails to change icon / set PE data](https://github.com/godotengine/godot/issues/27765) | 8 |
...
| godotengine/godot | C++ | [Using the RenderingServer to add a texture to the scene, the texture appears at bad position during one frame](https://github.com/godotengine/godot/issues/94988) | 9 |
| godotengine/godot | C++ | [Description missing from theme properties on type variations](https://github.com/godotengine/godot/issues/94790) | 9 |
...
| godotengine/godot | C++ | [[TRACKER] Unit tests to add or improve](https://github.com/godotengine/godot/issues/43440) | 190 |
...
| ansible/receptor-collection | Jinja | [Support for Debian 12](https://github.com/ansible/receptor-collection/issues/63) | 2 |
...
| django/djangoproject.com | PostScript | [Github login doesn't work for community pages](https://github.com/django/djangoproject.com/issues/835) | 3 |
...
| django/djangoproject.com | PostScript | [Add Click to copy text for commands present in the official Django website.](https://github.com/django/djangoproject.com/issues/1276) | 17 |
...
| ansible/django-ansible-base | Python | [Remove model imports in any utils/ modules](https://github.com/ansible/django-ansible-base/issues/443) | 0 |
| ansible/django-ansible-base | Python | [Convert to CommandError](https://github.com/ansible/django-ansible-base/issues/211) | 0 |
| ansible/galaxy_collection | Python | [Replace order of roles](https://github.com/ansible/galaxy_collection/issues/396) | 0 |
| ansible/galaxy_collection | Python | [infra.ah_configuration.publish leaves clone dirs behind](https://github.com/ansible/galaxy_collection/issues/377) | 0 |
...
| pytorch/torchtune | Python | [Add `eom_id` to stop tokens list for Llama family](https://github.com/pytorch/torchtune/issues/1483) | 0 |
| pytorch/torchtune | Python | [[Phi3 tokenizer] Ensure ``eos_token`` is not added if ``add_eos=False``](https://github.com/pytorch/torchtune/issues/1481) | 0 |
| pytorch/torchtune | Python | [[Gemma tokenizer] Ensure ``eos_token`` is not added if ``add_eos=False``](https://github.com/pytorch/torchtune/issues/1480) | 0 |
| pytorch/torchtune | Python | [[Mistral tokenizer] Ensure ``eos_token`` is not added if ``add_eos=False``](https://github.com/pytorch/torchtune/issues/1479) | 0 |
| pytorch/torchtune | Python | [[Qwen2 tokenizer] Ensure ``eos_token`` is not added if ``add_eos=False``](https://github.com/pytorch/torchtune/issues/1478) | 0 |
...
| ansible/awx | Python | [cancelled vs canceled - standardize spelling in codebase](https://github.com/ansible/awx/issues/15177) | 2 |
...
| pytorch/pytorch | Python | [dynamo (re)compilation issues: shape (1,1), nn.Parameter, mark_dynamic](https://github.com/pytorch/pytorch/issues/135011) | 2 |
...
| pytorch/pytorch | Python | [Add dynamo support to itertools.pairwise](https://github.com/pytorch/pytorch/issues/133766) | 3 |
...
| pytorch/pytorch | Python | [Very large memory increase when combining bfloat16 autocast with torch.compile](https://github.com/pytorch/pytorch/issues/133637) | 7 |
...
| pandas-dev/pandas | Python | [DOC: fix docstring validation errors for pandas.Timedelta/pandas.TimedeltaIndex](https://github.com/pandas-dev/pandas/issues/59698) | 12 |
...
| pandas-dev/pandas | Python | [TST: mixed_int_string Index](https://github.com/pandas-dev/pandas/issues/54072) | 14 |
...
| pandas-dev/pandas | Python | [DOC: fix docstring validation errors for pandas.Series](https://github.com/pandas-dev/pandas/issues/59592) | 20 |
| pandas-dev/pandas | Python | [DOC: fix docstring validation errors for `pandas.Timestamp`](https://github.com/pandas-dev/pandas/issues/59458) | 21 |
