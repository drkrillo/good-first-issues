...
## List of Good First Issues to start Collaborating!:surfer:<sub><sub>Last run: 2023-11-21</sub></sub>
...
| pandas-dev/pandas | Python | [BUG: Parquet size grows exponential for categorical data ](https://github.com/pandas-dev/pandas/issues/55776) | 6 |
...
| pandas-dev/pandas | Python | [BUG: read_sql no longer works simply with SqlAlchemy selectables and a quick fix](https://github.com/pandas-dev/pandas/issues/35484) | 7 |
