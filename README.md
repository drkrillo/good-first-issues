...
## List of Good First Issues to start Collaborating! :surfer: <sub><sub>Last run: 2024-05-18</sub></sub>

| Repo | Language | Title | Comments |
| --- | --- | --- | --- |
| godotengine/godot | C++ | [Shadows don't update when changing blend shape values](https://github.com/godotengine/godot/issues/91871) | 1 |
| godotengine/godot | C++ | [Compatibility renderer breaks shader](https://github.com/godotengine/godot/issues/91919) | 2 |
...
| godotengine/godot | C++ | [Blur shader doesn't work in WebGL 2.0](https://github.com/godotengine/godot/issues/91717) | 4 |
...
| godotengine/godot | C++ | [Blurry PointLight2D texture in Gl_compatibility backend](https://github.com/godotengine/godot/issues/90360) | 5 |
...
| godotengine/godot | C++ | [OpenGL: Environment fog does not affect sky rendering](https://github.com/godotengine/godot/issues/66456) | 6 |
...
| godotengine/godot | C++ | [[TRACKER] Unit tests to add or improve](https://github.com/godotengine/godot/issues/43440) | 176 |
...
| godotengine/godot-benchmarks | GDScript | [[Call to Action] Benchmarks for the benchmark server](https://github.com/godotengine/godot-benchmarks/issues/36) | 2 |
...
| ansible/ansible-documentation | Python | [Incorporate 'shared snippets' for the collection docs into the main rst files](https://github.com/ansible/ansible-documentation/issues/1382) | 1 |
| ansible/ansible-documentation | Python | [Document how to tag releases](https://github.com/ansible/ansible-documentation/issues/1272) | 1 |
...
| ansible/awx | Python | [cancelled vs canceled - standardize spelling in codebase](https://github.com/ansible/awx/issues/15177) | 1 |
...
| ansible/awx | Python | [Allow Kubernetes credentials on SCM inventories](https://github.com/ansible/awx/issues/15165) | 3 |
...
| pandas-dev/pandas | Python | [Extreme performance issue in pandas 1.0.3 when setting a new column with DatetimeIndex](https://github.com/pandas-dev/pandas/issues/34531) | 8 |
...
| pandas-dev/pandas | Python | [WEB: Multiple "Getting Started" on pandas.io leads to different links](https://github.com/pandas-dev/pandas/issues/32307) | 11 |
...
| pandas-dev/pandas | Python | [DOC: Add docstrings for MultiIndex.levels and MultiIndex.codes](https://github.com/pandas-dev/pandas/issues/55435) | 20 |
...
| godotengine/godot-docs | reStructuredText | [Example for (Basis * Vector3) is incorrect](https://github.com/godotengine/godot-docs/issues/9394) | 1 |
