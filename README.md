...
| pandas-dev/pandas | Python | [BUG: Inconsistent treatment of NaNs when `.apply()` function is used on categorical columns](https://github.com/pandas-dev/pandas/issues/59938) | 2 |
