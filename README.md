...
## List of Good First Issues to start Collaborating!:surfer:<sub><sub>Last run: 2023-11-26</sub></sub>

| Repo | Language | Title | Comments |
| --- | --- | --- | --- |
| opencv/opencv | C++ | [Update DNN Optical Flow sample with RAFT model](https://github.com/opencv/opencv/issues/24424) | 3 |
| godotengine/godot | C++ | [AnimatedSprite2D's animation does not play properly if the previous set animation wasn't set to looping](https://github.com/godotengine/godot/issues/85203) | 3 |
