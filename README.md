...
## List of Good First Issues to start Collaborating!:surfer:<sub><sub>Last run: 2023-11-09</sub></sub>
...
| godotengine/godot | C++ | [NavigationServer API is missing some getter functions](https://github.com/godotengine/godot/issues/84495) | 3 |
...
| godotengine/godot | C++ | [C# glue for `EditorSceneFormatImporter::get_import_options` overload is missing return value for `options`](https://github.com/godotengine/godot/issues/84516) | 5 |
...
| godotengine/godot | C++ | [Change StringName `&` inspector hint to be harder to confuse with actual text](https://github.com/godotengine/godot/issues/84219) | 12 |
...
| godotengine/godot | C++ | [[TRACKER] Unit tests to add or improve](https://github.com/godotengine/godot/issues/43440) | 140 |
...
| zeromicro/go-zero | Go | [CORS optimization](https://github.com/zeromicro/go-zero/issues/3311) | 4 |
...
| pandas-dev/pandas | Python | [DOC: Add docstrings for MultiIndex.levels and MultiIndex.codes](https://github.com/pandas-dev/pandas/issues/55435) | 6 |
