...
## List of Good First Issues to start Collaborating!:surfer:<sub><sub>Last run: 2024-01-06</sub></sub>

| Repo | Language | Title | Comments |
| --- | --- | --- | --- |
| opencv/opencv | C++ | [Update DNN Optical Flow sample with RAFT model](https://github.com/opencv/opencv/issues/24424) | 4 |
...
| godotengine/godot | C++ | [Normal Map Disabled With Detail Active](https://github.com/godotengine/godot/issues/85413) | 5 |
| godotengine/godot | C++ | [Decal with MeshTexture appears broken (not visible, and also affects other decals)](https://github.com/godotengine/godot/issues/77564) | 5 |
| godotengine/godot | C++ | [Inconsistant `UV` coordinates between `Forward+` and `Compatibility`](https://github.com/godotengine/godot/issues/86746) | 6 |
...
| godotengine/godot | C++ | [Android export error when deleting the default icon.png](https://github.com/godotengine/godot/issues/39218) | 6 |
...
| godotengine/godot | C++ | [[TRACKER] Unit tests to add or improve](https://github.com/godotengine/godot/issues/43440) | 144 |
...
| django/djangoproject.com | PostScript | [BLOCKER - The page’s second column content is hidden in print stylesheets.](https://github.com/django/djangoproject.com/issues/1410) | 9 |
...
| django/djangoproject.com | PostScript | [Add Click to copy text for commands present in the official Django website.](https://github.com/django/djangoproject.com/issues/1276) | 15 |
...
| ansible/awx | Python | [Fix Delinea imports and import test](https://github.com/ansible/awx/issues/14703) | 1 |
...
| ansible/ansible-documentation | Python | [Connection plugins: keyword and variable aren't mentioned](https://github.com/ansible/ansible-documentation/issues/793) | 2 |
...
| ansible/ansible-runner | Python | [Update links to EE getting started guide.](https://github.com/ansible/ansible-runner/issues/1328) | 2 |
| ansible/awx | Python | [Link to docs in UI's Help Button needs to go to the AWX docs](https://github.com/ansible/awx/issues/14699) | 2 |
...
| pandas-dev/pandas | Python | [ENH: raise TypeError if offsets which are not supported as period frequency pass to asfreq  ](https://github.com/pandas-dev/pandas/issues/56718) | 4 |
| pandas-dev/pandas | Python | [CLN: Use assert_produces_warning instead of pytest.raises to show FutureWarning](https://github.com/pandas-dev/pandas/issues/56716) | 4 |
...
| pandas-dev/pandas | Python | [BUG: Series.diff does no arg validation unlike df.diff for `periods`](https://github.com/pandas-dev/pandas/issues/56607) | 8 |
...
| pandas-dev/pandas | Python | [DOC: Fix docs for various offset constructors](https://github.com/pandas-dev/pandas/issues/52431) | 14 |
...
| StanGirard/quivr | TypeScript | [[Contribute]:  Want to get your hands dirty ? ](https://github.com/StanGirard/quivr/issues/1787) | 1 |
| StanGirard/quivr | TypeScript | [[Advent of Code] 🎄🎄 Have fun building OSS](https://github.com/StanGirard/quivr/issues/1786) | 1 |
| StanGirard/quivr | TypeScript | [[Feature]: API Key Management](https://github.com/StanGirard/quivr/issues/1793) | 2 |
| StanGirard/quivr | TypeScript | [[Feature]:  Terraform AWS, GCP, Azure](https://github.com/StanGirard/quivr/issues/1792) | 2 |
| StanGirard/quivr | TypeScript | [[Feature]:  Allow users to create and share prompts](https://github.com/StanGirard/quivr/issues/1790) | 2 |
| StanGirard/quivr | TypeScript | [[Feature]: Explore Brains is nicer](https://github.com/StanGirard/quivr/issues/1788) | 2 |
...
| StanGirard/quivr | TypeScript | [[Feature]:  Embed a Quivr chat on a website](https://github.com/StanGirard/quivr/issues/1791) | 4 |
...
| godotengine/godot-docs | reStructuredText | [Add description of MAX_MESH_SURFACES to Mesh class ](https://github.com/godotengine/godot-docs/issues/8720) | 0 |
| godotengine/godot-docs | reStructuredText | [4.2 Official Style Guide Error with Ctrl + K Shortcut](https://github.com/godotengine/godot-docs/issues/8560) | 4 |
